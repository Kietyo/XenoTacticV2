...
internal class GameMapTest {
    ...
    fun getAllRocksAtPoint_oneRock_1x1() {
        val map = GameMap(10, 10)
        map.placeEntity(MapEntity.Rock(1, 1, 1, 1))
        assertContentEquals(
            sequenceOf(MapEntity.Rock(1, 1, 1, 1)),
    ...
    fun getAllRocksAtPoint_oneRock_4x2() {
        val map = GameMap(10, 10)
        map.placeEntity(MapEntity.Rock(1, 1, 4, 2))
        assertContentEquals(
            sequenceOf(MapEntity.Rock(1, 1, 4, 2)),
            map.getAllRocksAtPoint(1, 1)
        )
        assertContentEquals(
            sequenceOf(MapEntity.Rock(1, 1, 4, 2)),
    ...
    fun removeEntity_oneEntity() {
        ...
        gameMap.placeEntity(MapEntity.Rock(1, 1, 2, 2))

        assertContentEquals(listOf(MapEntity.Rock(1, 1, 2, 2)), gameMap.getAllEntities())

        gameMap.removeEntity(MapEntity.Rock(1, 1, 2, 2))
